...
tools = [{
    ...
    "function": {
        "name": "kubectl",
        "description": "execute kubectl commands against a k8s cluster",
        "parameters": {
            "type": "object",
            "properties": {
                "cmd": {
                    "type": "string",
                    "description": "The kubectl command to execute, (without kubectl, just the arguments). For example, 'get pods'"
                }
            },
            "required": ["cmd"]
        }
